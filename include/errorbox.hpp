...
auto CreateErrorBox(const char *message,
                    std::optional<SDL_Window *> window = std::nullopt) noexcept
  ...
  const bool message_box_result =
      SDL_ShowSimpleMessageBox(std::to_underlying(box_type), box_title, message,
